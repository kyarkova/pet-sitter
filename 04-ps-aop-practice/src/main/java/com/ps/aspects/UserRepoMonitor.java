...
public class UserRepoMonitor {
    ...
    @Before("PointcutContainer.serviceUpdate(service, id, pass)")
    ...
    @AfterReturning(value = "execution( * com.ps.repos.*.*Service+.update*(..))", returning = "result")
    ...
    @AfterThrowing(value = "execution( * com.ps.repos.*.*Service+.updateUsername(..))", throwing = "e")
